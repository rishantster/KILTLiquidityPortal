...
- July 08, 2025. Perfected logo scaling in claimable amount display by using h-[1em] w-auto to match logo height exactly with text height, creating seamless visual integration between logo and text for professional appearance