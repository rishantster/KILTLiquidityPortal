...
- July 08, 2025. Perfected logo scaling in claimable amount display by using h-[3em] w-auto to make logo much bigger and more prominent, and changed KILT Price card background from green to purple-to-pink gradient (from-purple-500 to-pink-600) to complement the pink logo, creating better visual harmony and professional appearance