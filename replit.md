...
- July 08, 2025. Perfected logo scaling in claimable amount display by using h-[0.6em] w-auto to match logo height exactly with individual character height (like the letter "K"), creating seamless visual integration between logo and text for professional appearance