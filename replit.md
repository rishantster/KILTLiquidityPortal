...
- July 08, 2025. Perfected logo scaling in claimable amount display by using h-[1.2em] w-auto to make logo bigger and match text size properly, creating prominent visual integration between logo and text for professional appearance