...
- **NEW CONTRACT DEPLOYMENT (Aug 2025)**: Updated entire application to use new enhanced DynamicTreasuryPool contract at address 0x09bcB93e7E2FF067232d83f5e7a7E8360A458175 with improved security features, SafeERC20 usage, and comprehensive validation. Updated database treasury_config, authorization scripts, and all documentation to reference new contract address.
