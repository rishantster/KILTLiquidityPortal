            ...
            <div className="space-y-3">
              <div className="text-center p-2 rounded border border-purple-500/20 bg-[#000000]">
                ...
                <div className="text-sm text-white flex items-center justify-center gap-2 numeric-display">
                  {programAnalytics?.totalBudget !== undefined && programAnalytics?.totalBudget !== null ? (programAnalytics.totalBudget >= 1000000 ? ((programAnalytics.totalBudget / 1000000).toFixed(1) + 'M') : ((programAnalytics.totalBudget / 1000).toFixed(0) + 'K')) : '500K'} <img src={kiltLogo} alt="KILT" className="h-4 w-4" />
                </div>
              </div>
