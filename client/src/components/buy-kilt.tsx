        ...
        <Card className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
          ...
          <CardContent className="pt-0">
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <Button
                variant="outline"
                className="w-full border-white/20 bg-black/30 backdrop-blur-sm text-white hover:bg-white/10 hover:border-white/30 rounded-xl px-6 py-3 transition-all duration-300"
